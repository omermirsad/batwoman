      ...
      <div className="relative z-10 p-4 container mx-auto">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 animate-fadeInUp animation-delay-400">
            ...
            <a href="#ai-chat" className="inline-flex items-center justify-center rounded-lg border border-indigo-600/50 bg-indigo-600/20 px-8 py-3 text-base font-bold text-indigo-300 transition-colors hover:bg-indigo-600/30">
              Ask Dr. Echo AI
            </a>
          </div>
        </div>
